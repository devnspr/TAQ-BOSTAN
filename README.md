...
---
راه حلی موثر برای مقابله با ایران اکسس شدن سرور ها!
---
...
3. **واردکردن اطلاعات**  
   ...
   - **مقدار پورت WireGuard** (پیش‌فرض 51822)  
...
- **سرور خارج**  
  ...
  5. مقدار MTU  
  6. فایل `/etc/wireguard/TAQBOSTANwg.conf` ساخته و آمادهٔ استفاده می‌شود.
